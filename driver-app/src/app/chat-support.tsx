        ...
        <View style={styles.container}>
          <ScrollView contentContainerStyle={styles.chatArea}>
            <View style={styles.messageBubbleLeft}>
              <Text style={styles.messageTextLeft}>Hola, ¿en qué podemos ayudarte con tu orden actual?</Text>
            </View>
            <Text style={styles.messageTime}>14:30</Text>

            <View style={styles.messageBubbleRight}>
              <Text style={styles.messageTextRight}>Tengo un problema con la dirección del cliente, no la encuentro.</Text>
          </View>
          <Text style={styles.messageTimeRight}>14:31</Text>

          <View style={styles.messageBubbleLeft}>
            <Text style={styles.messageTextLeft}>Entendido. Intentaremos contactar al cliente por ti o brindarte más detalles. Dame un momento.</Text>
          </View>
